...
export default function ManagerHeader() {
  ...
  return (
    <Popover  className={clsx(
      currentUser && currentUser.user_type == 't' ? "bg-gradient-to-r from-[#150f35] from-10% via-[#b55742] via-50% to-[#150f35] to-90%" : currentUser && currentUser.user_type == 'm' ? "bg-gradient-to-r from-[#150f35] from-10% via-[#b55742] via-50% to-[#150f35] to-90%" : "bg-gradient-to-r from-gray-900  to-emerald-900",
      "relative"
    )}>
